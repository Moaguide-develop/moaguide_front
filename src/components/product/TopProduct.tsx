            ...
            {summary?.map((item, idx) => {
              return (
                <SwiperSlide key={item.product_Id}>
                  <TopProductLayout item={item} idx={idx} />
                </SwiperSlide>
              );
            })}
          </Swiper>
...
const TopProductLayout = ({ item, idx }: { item: ISummary; idx: number }) => {
  return (
          ...
          <div className="flex flex-col justify-center items-center mt-[20px] mx-auto">
              ...
              <div className="absolute top-1 left-1">
                <div className="relative">
                  <Image
                    ...
                    width={44}
                    height={44}></Image>
                  <div className="text-white absolute top-2 left-[18px] ">{idx + 1}</div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full ">
              ...
              <div className="flex mt-[10px ] ml-[20px]">
                <div className="text-gray-400">{item.price.toLocaleString()}원</div>
                <div
                  className={`ml-[3px] ${
                    item.priceRate > 0
                      ? 'text-red-500'
