  ...
  return (
    <section className="relative mt-12">
      <div className="">
        ...
        <div className="sm:hidden mx-auto w-[80%]">
          <Swiper
            slidesPerView={1.3}
            centeredSlides={true}
            spaceBetween={16}
          ...
          >
            {Array.from({ length: 3 }).map((_, index) => (
              <SwiperSlide key={index}>
                <div className="relative w-full h-[350px] bg-gray-300 rounded-lg animate-pulse" />
              </SwiperSlide>
            ))}
          </Swiper>
...
export default RecentContentsSkeleton;