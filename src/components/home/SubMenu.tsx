  ...
  return (
    <div>
      ...
      <div className="sm:hidden flex justify-center gap-[12px]">
        <div className="max-w-[110px] w-full px-[27px] py-4 flex flex-col justify-center items-center gap-3   rounded-[12px] border border-gray100">
          <div>
            <img src="/images/home/phone.svg" alt="phone" className="w-10 desk2:w-full" />
          </div>
          <div className="text-mobileTitle text-gray700">최신이슈</div>
        </div>
        <div className="max-w-[110px] w-full px-[16px] py-4 flex flex-col justify-center items-center gap-3  rounded-[12px] border border-gray100">
          <div>
            <img src="/images/home/box.svg" alt="box" className="w-10 desk2:w-full" />
          </div>
