      ...
      <div className='flex flex-col mx-auto'>
        <div className='flex flex-col justify-start sm:justify-between sm:items-center mt-[52px] py-[30px] w-[90%] lg:w-full mx-auto desk:max-w-[1000px] bg-gradient2 rounded-[12px]'>
          <div className='w-[90%] mx-auto'>
            ...
            <div className='flex flex-col justify-start text-white text-sm'>
              <div>1. 모아가이드에서 제공하는 상품정보와 금액은 일치하지 않을 수 있습니다. 해당 플랫폼에서 상품정보 및 금액을 반드시 확인해 주시기 바랍니다.</div>
              <div>2. 모아가이드는 고객이 플랫폼에서 구매한 투자 상품에 대해 보증하거나 별도의 책임을 지지 않으며, 투자상품 거래와 관련한 일체의 책임은 해당 플랫폼 및 사용자 각자에게 있습니다.</div>
              <div>3. 고객께서는 투자상품 거래 전 해당 플랫폼의 이용약관을 반드시 확인해 주시기 바랍니다.</div>
              <div>4. 모아가이드는 정보통신업을 영위하며 투자 자문업, 투자 일임업 등 고객에 대한 자산 운용 관련업을 영위하지 않습니다.</div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div>
            ...
            <div className="flex sm:hidden mt-[20px] text-[16px] font-normal text-gray700">Copyright © 2024. MOA GUIDE. All Rights Reserved.</div>
          </div>
        </div>
      </div>
