    ...
    <div>
      ...
      <div className=" flex flex-col justify-center items-center">
        {QuizData?.score !== null ? (
          <div className="flex flex-col justify-center items-center">
            ...
            <div className=" flex flex-col justify-center items-center mb-[20px]">
              ...
              <div className=" text-2xl font-bold">
                {/* 점수  api*/}{' '}
                <span className=" text-violet-600">{QuizData?.score}</span>/ 100점
              </div>
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="text-2xl font-bold  mt-5 mb-7 ">
              아직 시험에 응시하지 않았네요
            </div>
        ...
        <div className=" mt-[60px] mb-[60px] w-full h-[2px] bg-gray-100" />
