...
const ProductBookmarkContentList = ({
  ...
  const handleProductClick = (productId: string, sale: boolean) => {
    if (sale) {
        ...
        <div>
          {content?.map((item) => (
            <div
              key={item.product_Id}
              className="lg:flex"
              onClick={() => handleProductClick(item.product_Id, item.sale)} 
            >
                ...
                <div className="flex items-center h-[110px]">
                  ...
                  <div className="flex-1 flex flex-col md:hidden desk:flex">
                    <div className="flex mb-[5px]">
                      ...
                      <div className="max-w-[80px] mr-[16px] text-gray-400">{item.platform}</div>
                    </div>
