...
import Skeleton from '../../../components/skeleton/NotificationSkeleton';
  ...
  return (
    <div className="">
      <div className="max-w-[360px] mx-auto desk:max-w-[1000px] w-[90%] lg:w-[100%] flex items-center gap-5 text-body5 sm:text-title2 mt-5">
        <div className={'pb-4 cursor-pointer text-gray700 border-b-2 border-normal'}>
          상품 알림
        </div>
      </div>
            ...
            <>
              <div
                ...
                <div className="flex flex-col justify-between h-full w-[80%] gap-5">
                  ...
                  <div className="text-black text-md">{notification.message}</div>
                </div>
